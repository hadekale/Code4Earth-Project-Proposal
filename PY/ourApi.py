...
def getHtml(asAFunctionOf: AsAFunctionOf, parameter: Parameter, experimentId: ExperimentId, verificationType: VerificationType, timeInterval: TimeInterval):
    ...
    plot.write_html("A:/Projeler/Code4Earth-Project-Proposal/PY/tempHtml.html")
    htmlFileToBeSent = open('A:/Projeler/Code4Earth-Project-Proposal/PY/tempHtml.html', 'r', encoding="utf8")
